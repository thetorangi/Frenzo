<template>
  <div class="bg-white dark:bg-gray-900 text-gray-800 dark:text-white min-h-screen">
    <!-- NAVBAR -->
    <nav
      class="flex items-center justify-between p-4 shadow-md bg-white dark:bg-gray-900 transition-all duration-300"
    >
      <!-- Left: App Name -->
      ...
      <div class="hidden md:flex items-center space-x-6 transition-all duration-300">
        <router-link to="/" @click.native="selectedIcon = 'home'" :class="iconClass('home')">
          <HomeIcon />
        </router-link>
        <router-link
          to="/search"
    ...
    <transition name="fade">
      <div
        v-if="menuOpen"
        class="md:hidden px-4 pb-4 space-y-3 bg-white dark:bg-gray-900 shadow-md rounded-b-lg"
      >
        <router-link
          to="/"
          @click.native="
  ...
  h(
    ...
    [
      h('path', {
        strokeLinecap: 'round',
        strokeLinejoin: 'round',
        d: 'M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.77 9.77 0 01-4-.84L3 21l1.7-4.6A7.972 7.972 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z',
      }),
    ],
  )
  ...
  h(
    ...
    [
      h('path', {
        strokeLinecap: 'round',
        strokeLinejoin: 'round',
        d: 'M12 3v1m0 16v1m8.66-13.66l-.707.707M4.05 19.95l-.707.707M21 12h1M2 12H1m16.95 7.05l-.707-.707M4.05 4.05l-.707-.707M16 12a4 4 0 11-8 0 4 4 0 018 0z',
      }),
    ],
  )
  ...
  h(
    ...
    [
      h('path', {
        strokeLinecap: 'round',
        strokeLinejoin: 'round',
        d: 'M21.752 15.002A9.718 9.718 0 0112 21c-5.385 0-9.75-4.365-9.75-9.75 0-4.193 2.697-7.747 6.435-9.154a0.75 0.75 0 01.93.97 7.5 7.5 0 008.385 10.936 0.75 0.75 0 01.752 1.001z',
      }),
    ],
  )
